...
/**
 * Allow a plugin to override the app version that is passed to index-template.html
 * @type {string}
 */
...
module.exports = {
  ...
  compiledCss: path.join(version, 'styles', 'opensphere-app-example.min.css'),
  compiledJs: path.join(version, 'opensphere-app-example.min.js')
};
